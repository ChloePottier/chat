...
<body>
  <div class="container-fluid">
    <div class="container" id="formContent">
      ...
      <p class="text-center text-white mt-20">Vous n'êtes pas encore inscrit ? <a href="inscription.php" class="compteInscription">Créer un compte</a></p>
      <p>
        <?php 
          $message = "";
          //connection à la BDD
          ...
          if (count($_POST) > 0) {
            ...
            if (is_array($row)) {
              ...
              echo  "<p class='text-center text-red'>Identifiant ou mot de passe invalide</p>";
            }
          }
          $connection = null;
